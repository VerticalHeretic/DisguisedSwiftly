...
extension UInt32 {
    ...
    /// Sets the bit 0 of the UInt32 to given bit
    public mutating func setb0(_ bit: Int) {
        let nv = bit != 0 ? 1 : 0
        self = (self & ~(0x1 << 0)) | (nv.toU32 << 0)
    }
    ...
    /// Sets the bit 1 of the UInt32 to given bit
    public mutating func setb1(_ bit: Int) {
        let nv = bit != 0 ? 1 : 0
        self = (self & ~(0x1 << 1)) | (nv.toU32 << 1)
    }
    ...
    /// Sets the bit 2 of the UInt32 to given bit
    public mutating func setb2(_ bit: Int) {
        let nv = bit != 0 ? 1 : 0
        self = (self & ~(0x1 << 2)) | (nv.toU32 << 2)
    }
    ...
    /// Sets the bit 3 of the UInt32 to given bit
    public mutating func setb3(_ bit: Int) {
        let nv = bit != 0 ? 1 : 0
        self = (self & ~(0x1 << 3)) | (nv.toU32 << 3)
    }
    ...
    /// Sets the bit 4 of the UInt32 to given bit
    public mutating func setb4(_ bit: Int) {
        let nv = bit != 0 ? 1 : 0
        self = (self & ~(0x1 << 4)) | (nv.toU32 << 4)
    }
    ...
    /// Sets the bit 5 of the UInt32 to given bit
    public mutating func setb5(_ bit: Int) {
        let nv = bit != 0 ? 1 : 0
        self = (self & ~(0x1 << 5)) | (nv.toU32 << 5)
    }
    ...
    /// Sets the bit 6 of the UInt32 to given bit
    public mutating func setb6(_ bit: Int) {
        let nv = bit != 0 ? 1 : 0
        self = (self & ~(0x1 << 6)) | (nv.toU32 << 6)
    }
